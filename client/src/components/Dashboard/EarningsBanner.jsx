...
const EarningsBanner = () => {
	...
	return (
		<div className='flex flex-wrap lg:flex-nowrap justify-center w-full'>
			<div className='flex flex-col bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center max-w-4xl'>
